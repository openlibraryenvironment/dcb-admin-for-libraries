    ...
    <Box>
      <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
        ...
        <MetricInfo
          ...
          // NOT just the tile's title: the headline figure above carries the same
          // words, and two buttons with one accessible name is a reader listing the
          // page's controls and hearing the same sentence twice.
